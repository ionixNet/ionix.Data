...
namespace ionixTests.SqlServer
{
        ...
        where TDbAccess : IDbAccess
    {
        ...
        public ICommandFactory Factory => DataFactory.CreateFactory(this.DataAccess);

        public ICommandAdapter Cmd => DataFactory.CreateCommandAdapter(this.DataAccess);
    ...
    public sealed class DbClient : DbClient<IDbAccess>
    {
        ...
        {
            return DataFactory.CreatDataAccess();
        }
    }
    ...
    public sealed class TransactionalDbClient : DbClient<ITransactionalDbAccess>, IDbTransaction
    {
        ...
        {
            return DataFactory.CreateTransactionalDataAccess();
        }
